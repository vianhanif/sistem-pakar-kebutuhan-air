...
function cuaca(){
  ...
  // $html = mycurl('http://www.bmkg.go.id/BMKG_Pusat/Informasi_Cuaca/Prakiraan_Cuaca/Prakiraan_Cuaca_Indonesia.bmkg');
    $html = mycurl('http://www.bmkg.go.id/BMKG_Pusat/Informasi_Cuaca/Prakiraan_Cuaca/Prakiraan_Cuaca_Propinsi.bmkg?prop=13');
							...
							'prakiraan' => array(
								'sekarang' => array(
									...
									'kelembaban' =>  array(
										...
										'max' => substr(str_replace(" %", "", $kelembaban_sekarang_minmax[1]), 0, 2)
									)
								),
								'besok' => array(
									'tgl' => $besok[1],
									'cuaca' => trim($cuaca_besok[0]),
									'suhu' => array(
									...
									'kelembaban' =>  array(
										...
										'max' => substr(str_replace(" %", "", $kelembaban_besok_minmax[1]), 0, 2)
									)
								)
							)
						);
